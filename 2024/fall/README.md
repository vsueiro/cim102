...
This is the main document for the CIM 102 (section 5T) course at University of Miami, fall 2024.

🗓 Classes on Thursdays, from `5:05 PM` to `7:50 PM` (with `15 min` break).
...
| Design Exercises | 20 Points | Interactive Prototype | Submission    | 5      |
| \*               | \*        | User Testing          | Presentation  | 10     |
| \*               | \*        | \*                    | Submission    | 5      |
| Design Project 1 | 30 Points | Wireframe             | Submission    | 5      |
| \*               | \*        | Mockup                | Submission    | 5      |
| \*               | \*        | Prototype             | Presentation  | 10     |
| \*               | \*        | \*                    | Peer Feedback | 5      |
| \*               | \*        | \*                    | Submission    | 5      |
| Design Project 2 | 30 Points | Wireframe             | Submission    | 5      |
| \*               | \*        | Mockup                | Submission    | 5      |
| \*               | \*        | Prototype             | Presentation  | 10     |
| \*               | \*        | \*                    | Peer Feedback | 5      |
| \*               | \*        | \*                    | Submission    | 5      |
